...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeleteRule.mask'
        db.delete_column('inbox_deleterule', 'mask')

        # Deleting field 'ForwardRule.mask'
        db.delete_column('inbox_forwardrule', 'mask')

        # Adding field 'InboxSettings.mask'
        db.add_column('inbox_inboxsettings', 'mask',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DeleteRule.mask'
        db.add_column('inbox_deleterule', 'mask',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForwardRule.mask'
        db.add_column('inbox_forwardrule', 'mask',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InboxSettings.mask'
        db.delete_column('inbox_inboxsettings', 'mask')
