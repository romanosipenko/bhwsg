...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('inbox_mailattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mail', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['inbox.Mail'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('inbox', ['MailAttachment'])


    def backwards(self, orm):
        # Deleting model 'MailAttachment'
        db.delete_table('inbox_mailattachment')
