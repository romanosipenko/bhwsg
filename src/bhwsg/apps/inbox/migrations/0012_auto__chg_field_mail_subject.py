...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('inbox_mail', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Mail.subject'
        db.alter_column('inbox_mail', 'subject', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))
    ...
    models = {
        ...
        'inbox.mail': {
            ...
            'readers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'mails'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
