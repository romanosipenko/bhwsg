...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mail.content_types'
        db.add_column('inbox_mail', 'content_types',
                      self.gf('core.fields.JSONField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mail.content_types'
        db.delete_column('inbox_mail', 'content_types')
